...
RUN apt-get update && apt-get install -y \
    openjdk-11-jdk curl wget tar iputils-ping python3.10 python3.10-venv python3.10-dev
...
RUN wget -P $SPARK_HOME/jars https://repo1.maven.org/maven2/io/delta/delta-spark_2.12/3.3.0/delta-spark_2.12-3.3.0.jar
RUN wget -P $SPARK_HOME/jars https://repo1.maven.org/maven2/io/delta/delta-storage/3.3.0/delta-storage-3.3.0.jar
